...
ActiveRecord::Schema[8.0].define(version: 2025_09_01_111410) do
  ...
  create_table "schedule_items", charset: "utf8mb4", collation: "utf8mb4_0900_ai_ci", force: :cascade do |t|
    ...
    t.string "url"
    t.integer "position"
    t.index ["plan_id", "day_number", "position"], name: "index_schedule_items_on_plan_id_and_day_number_and_position"
